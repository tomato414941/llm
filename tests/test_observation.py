...
def observation() -> Observation:
    return Observation(
        output_path=Path("runs/from-scratch/observations/example.md"),
        checkpoint_path=Path("runs/from-scratch/example/checkpoint.pt"),
        tokens_path=Path("data/from-scratch/processed/example.pt"),
        checkpoint_step=10,
