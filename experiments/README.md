...
- `first-training-observation.md`: hand-written notes for learning how to read a run.
...
evaluator to produce reviewable CSV summaries. Use `evals/leverage-smoke.jsonl`
as the smoke layer and `evals/project-judgment-v0.jsonl` as the
